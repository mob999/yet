...
class _ActionsClient implements ActionsClient {
  ...
  @override
  Future<List<ActionDefinition>> getDefinitionsActionsDefinitionsGet() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ActionDefinition>>(
    ...
    late List<ActionDefinition> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ActionDefinition.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<ActionDefinition> createDefinitionActionsDefinitionsPost({
    required ActionDefinitionCreate body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    try {
      _value = ActionDefinition.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<List<ActionRecord>> getMyRecordsActionsRecordsGet() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
