...
class _UsersClient implements UsersClient {
  ...
  @override
  Future<User> registerUsersRegisterPost({required UserCreate body}) async {
  ...
  Future<Token> loginUsersLoginPost({
    required BodyLoginUsersLoginPost body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<User> readUsersMeUsersMeGet() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<UserProfile> updateMyProfileUsersMeProfilePut({
    required UserProfileUpdate body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
